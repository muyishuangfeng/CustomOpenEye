...
class DownloadAdapter(context: Context, list: ArrayList<VideoBean>) : RecyclerView.Adapter<DownloadAdapter.DownloadViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DownloadViewHolder {
        return DownloadViewHolder(inflater?.inflate(R.layout.item_cache_layout, parent, false), context!!)
    }
    ...
    override fun onBindViewHolder(holder: DownloadViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            var collect = list?.get(position)?.collection
    ...
    class DownloadViewHolder(itemView: View?, context: Context) : RecyclerView.ViewHolder(itemView!!) {
        var iv_photo: AppCompatImageView = itemView?.findViewById(R.id.iv_photo) as AppCompatImageView
        var tv_title: TextView = itemView?.findViewById(R.id.tv_title) as TextView
        var tv_detail: TextView = itemView?.findViewById(R.id.tv_detail) as TextView
        var iv_download_state: AppCompatImageView = itemView?.findViewById(R.id.iv_download_state) as AppCompatImageView
